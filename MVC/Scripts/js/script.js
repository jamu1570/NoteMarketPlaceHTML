...
$(function() {
  ...
  function ShowHideNav() {
    if ($(window).scrollTop() > 50) {
      ...
      // Show dark logo
      $(".navbar-brand-2 img").attr("src", "/Content/images/Login/top-logo_2.png");
    } else {
      // Hide white nav
      $("header").addClass("navbar-transparent");
      // Show dark logo
      $(".navbar-brand-2 img").attr("src", "/Content/images/Login/top-logo.png");
    }
    if ($(window).width() < 768) {
      $("header").removeClass("navbar-transparent");
      // Show dark logo
      $(".navbar-brand img").attr("src", "/Content/images/Login/top-logo_2.png");
    } else {
      //
    }
  }
